...
date: 2026-06-14
published_at: 2026-06-14T06:36:50.694415+00:00
tag: 工具开源
...
SSH errors?The marketplace clones repos via SSH. If you don't have SSH keys set up on GitHub, either[add your SSH key](https://docs.github.com/en/authentication/connecting-to-github-with-ssh/adding-a-new-ssh-key-to-your-github-account)or use the full HTTPS URL to force the HTTPS cloning:/plugin marketplace add https://github.com/addyosmani/agent-skills.git /plugin install agent-skills@addy-agent-skills
...
`agy plugin install https://github.com/addyosmani/agent-skills.git`**Install from a local clone:**
...
`gemini skills install https://github.com/addyosmani/agent-skills.git --path skills`**Install from a local clone:**
