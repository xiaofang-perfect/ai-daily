...
date: 2026-06-20
published_at: 2026-06-19T10:40:24+00:00
tag: 论文研究
item_id: 1a46006992b401da
---
# A startup claims it broke through a bottleneck that’s holding back LLMs

Subquadratic has now shared more details about its new model. But some are still skeptical.

![a cheetah running out of frame to the right with the squares of an attention grid encroaching to the left](https://wp.technologyreview.com/wp-content/uploads/2026/06/cheetah-speed2a.jpg)
...
Appen also ran the needle-in-a-haystack test, which assesses how well a model can retrieve specific information buried in a large amount of data. In its report, Appen states that [SubQ scored 98% with context windows six million and 12 million tokens long](https://www.appen.com/whitepapers/subquadratic-preview-model-benchmark-evaluation), “sustaining near-perfect long-context retrieval at scales few models are tested at.”
...
Until more people get their hands on the model and try it out for themselves, some skepticism is justified. One nagging issue is that Subquadratic reused the weights ([values set within a model during training that determine how it will behave](https://www.technologyreview.com/2026/01/07/1130795/what-even-is-a-parameter/)) from a version of the Chinese open-source model Qwen to bootstrap SubQ, rather than training it from scratch. That’s a common thing for model makers to do, but it cuts across Subquadratic’s claim that it has fully reinvented how LLMs work.  
