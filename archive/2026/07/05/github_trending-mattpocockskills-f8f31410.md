...
date: 2026-07-05
published_at: 2026-07-05T06:03:13.943252+00:00
tag: 工具开源
...
- [code-review](https://github.com/mattpocock/skills/blob/main/skills/engineering/code-review/SKILL.md)- **Standards**(does it follow the repo's coding standards, plus a Fowler smell baseline?) and- **Spec**(does it faithfully implement the originating issue/PRD?), run as parallel sub-agents so neither pollutes the other.
