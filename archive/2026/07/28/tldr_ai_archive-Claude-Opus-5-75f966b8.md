---
title: "Claude Opus 5"
source: TLDR AI · 2026-07-27
url: https://www.anthropic.com/news/claude-opus-5?utm_source=tldrai
date: 2026-07-28
published_at: 2026-07-27T12:00:00+00:00
tag: 产品发布
item_id: 75f966b896bdc04c
---
...
Based on our testing, we expect the classifiers to intervene around 85% less often than they do for Fable 5. In [Claude.ai](http://claude.ai/redirect/website.v1.47919b3d-fc17-4653-8a7f-0fd55d9421c0), Claude Code, and Claude Cowork, any flagged requests will fall back to Opus 4.8 by default. Fallbacks to Opus 4.8 can also be enabled on the API.
...
- [Mid-conversation tool changes](https://platform.claude.com/docs/en/build-with-claude/mid-conversation-system-messages)on the Claude Platform.
- [Automatic fallbacks](https://platform.claude.com/docs/en/build-with-claude/refusals-and-fallback#server-side-fallback)on the API.
