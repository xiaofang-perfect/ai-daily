...
date: 2026-07-12
published_at: 2026-07-12T05:23:53.935228+00:00
tag: 工具开源
item_id: 19afab213bac9a99
---
...
- [How to install](https://github.com#how-to-install)
- [Getting Started](https://github.com#getting-started)
- [Usage](https://github.com#usage)
- [File Preview UI & Markdown Editor](https://github.com#file-preview-ui--markdown-editor)
- [Handling Long-Running Commands](https://github.com#handling-long-running-commands)
- [Work in Progress and TODOs](https://github.com#roadmap)
- [Sponsors and Supporters](https://github.com#support-desktop-commander)
- [Website](https://github.com#website)
- [Media](https://github.com#media)
- [Testimonials](https://github.com#testimonials)
- [Frequently Asked Questions](https://github.com#frequently-asked-questions)
...
- [Docker isolation](https://github.com#option-6-docker-installation--auto-updates-no-nodejs-required)for full sandboxing
...
- **Visit:**- [https://smithery.ai/server/@wonderwhy-er/desktop-commander](https://smithery.ai/server/@wonderwhy-er/desktop-commander)
...
`iex ((New-Object System.Net.WebClient).DownloadString('https://raw.githubusercontent.com/wonderwhy-er/DesktopCommanderMCP/refs/heads/main/install-docker.ps1'))`The installer will check Docker, pull the image, prompt for folder mounting, and configure Claude Desktop.
...
`bash <(curl -fsSL https://raw.githubusercontent.com/wonderwhy-er/DesktopCommanderMCP/refs/heads/main/install-docker.sh) --reset && bash <(curl -fsSL https://raw.githubusercontent.com/wonderwhy-er/DesktopCommanderMCP/refs/heads/main/install-docker.sh)`**✅ Auto-Updates:** Yes - `latest` tag automatically gets newer versions
...
`claude mcp add --scope user desktop-commander -- npx -y @wonderwhy-er/desktop-commander@latest`Remove `--scope user` to install for the current project only. See [Claude Code MCP docs](https://docs.anthropic.com/en/docs/claude-code/mcp) for more info.
...
`codex mcp add desktop-commander -- npx -y @wonderwhy-er/desktop-commander@latest`Or manually add to `~/.codex/config.toml`:
...
`qwen mcp add desktop-commander -- npx -y @wonderwhy-er/desktop-commander@latest`Or add to `.qwen/settings.json` (project) or `~/.qwen/settings.json` (global). See [Qwen Code MCP docs](https://qwenlm.github.io/qwen-code-docs/en/developers/tools/mcp-server/) for more info.
...
`npx @wonderwhy-er/desktop-commander@latest remove`This automatic uninstaller will:
...
- 
**Install Docker for Windows/Mac**- Download and install Docker Desktop from [docker.com](https://www.docker.com/products/docker-desktop/)
 
- Download and install Docker Desktop from 
- 
**Get Desktop Commander Docker Configuration**- Visit: [https://hub.docker.com/mcp/server/desktop-commander/manual](https://hub.docker.com/mcp/server/desktop-commander/manual)
- **Option A:**Use the provided terminal command for automated setup
- **Option B:**Click "Standalone" to get the config JSON and add it manually to your Claude Desktop config![docker-config.png](/wonderwhy-er/DesktopCommanderMCP/raw/main/screenshots/docker-config.png) 
...
- Expand the file preview to fullscreen using the **⤢ Expand**button
...
- 
**The**, not terminal commands. Terminal commands can still access files outside allowed directories.`allowedDirectories`setting currently only restricts filesystem operations
- 
...
- 
**Be careful with empty**: Setting this to an empty array (`allowedDirectories``[]`) grants access to your entire filesystem for file operations.
- 
...
| [
        ](https://github.com/jonrichards)Jon Richards![Jon Richards](https://github.com/jonrichards.png)  | [
        ](https://github.com/stepanic)Matija Stepanic![Matija Stepanic](https://github.com/stepanic.png)  | 
...
![analyticsindiamag.png](https://github.com/wonderwhy-er/DesktopCommanderMCP/raw/main/testemonials%2Fanalyticsindiamag.png) This Developer Ditched Windsurf, Cursor Using Claude with MCPs
