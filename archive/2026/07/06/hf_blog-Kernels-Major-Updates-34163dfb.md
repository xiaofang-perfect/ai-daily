...
[  Upvote 2 ](https://huggingface.co/login?next=%2Fblog%2Frevamped-kernels)

![Sayak Paul's avatar](https://cdn-avatars.huggingface.co/v1/production/uploads/1649681653581-5f7fbd813e94f16a85448745.jpeg) 

  ![Daniël de Kok's avatar](https://cdn-avatars.huggingface.co/v1/production/uploads/6310e9a107a76827902421d7/1e0GItqv3A6sOWYz5SXoe.png) 

  ![David Holtz's avatar](https://cdn-avatars.huggingface.co/v1/production/uploads/6452d5ba3f80ad88c77b2f05/yuvfzgqOeK8-bFxEZ2gg9.jpeg) 
...
- [Kernels – a new repository type](https://huggingface.co#kernels--a-new-repository-type)
- [Improved security](https://huggingface.co#improved-security)
- [Revamped CLIs](https://huggingface.co#revamped-clis)
- [More coverage of frameworks and backends](https://huggingface.co#more-coverage-of-frameworks-and-backends)
- [Foundation for agentic kernel development](https://huggingface.co#foundation-for-agentic-kernel-development)
- [Misc](https://huggingface.co#misc)
...
![Flash Attention 3 Kernel Page](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/revamped-kernels/flash-attn3.png) 
    ...
    [kernels-community/flash-attn3](https://huggingface.co/kernels/kernels-community/flash-attn3)
...
## 
	...
	](https://huggingface.co#more-coverage-of-frameworks-and-backends-more-coverage-of-frameworks-and-backends)
