...
tag: 工具开源
item_id: 4b39f27240b478b1
---
Robotics •  4B • Updated   •  15  •  5  

#### lerobot/Robometer-4B

![](https://cdn-avatars.huggingface.co/v1/production/uploads/631ce4b244503b72277fc89f/pcLUTLsvMQiR-ujlTgLYF.png) 
...
- [LeRobot v0.6.0: Imagine, Evaluate, Improve](https://huggingface.co#lerobot-v060-imagine-evaluate-improve)- [TL;DR](https://huggingface.co#tldr)
- [Table of contents](https://huggingface.co#table-of-contents)
- [World models: policies that imagine](https://huggingface.co#world-models-policies-that-imagine)
- [VLAs: the model zoo keeps growing](https://huggingface.co#vlas-the-model-zoo-keeps-growing)
- [Reward models: knowing when your robot succeeds](https://huggingface.co#reward-models-knowing-when-your-robot-succeeds)
- [Datasets: faster loading, richer data](https://huggingface.co#datasets-faster-loading-richer-data)
- [Benchmarks: one CLI to evaluate them all](https://huggingface.co#benchmarks-one-cli-to-evaluate-them-all)
- [Training & inference](https://huggingface.co#training--inference)
- [Codebase: leaner and cleaner](https://huggingface.co#codebase-leaner-and-cleaner)
- [Community & ecosystem](https://huggingface.co#community--ecosystem)
...
[release notes](https://github.com/huggingface/lerobot/releases)for the full list and migration pointers for the breaking changes.
...
– The LeRobot team ❤️
 ...
 Robotics •  6B • Updated   •  53  •  4 

 Robotics •  3B • Updated   •  44k  •  65 
