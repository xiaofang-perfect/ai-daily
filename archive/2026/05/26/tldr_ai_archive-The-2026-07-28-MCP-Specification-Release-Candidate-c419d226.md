...
url: https://blog.modelcontextprotocol.io/posts/2026-07-28-release-candidate/?utm_source=tldrai
date: 2026-05-26
published_at: 2026-05-25T12:00:00+00:00
tag: 工具开源
item_id: c419d226ea121738
---
...
## A Stateless Protocol[#](https://blog.modelcontextprotocol.io#a-stateless-protocol)
...
[The Future of MCP Transports](https://blog.modelcontextprotocol.io/posts/2025-12-19-mcp-transport-future/) in
December.

### Before and after[#](https://blog.modelcontextprotocol.io#before-and-after)

In [ 2025-11-25](https://blog.modelcontextprotocol.io/posts/2025-11-25-first-mcp-anniversary/), calling a tool over
...
### The handshake and session are gone[#](https://blog.modelcontextprotocol.io#the-handshake-and-session-are-gone)
...
### Stateless protocol, stateful applications[#](https://blog.modelcontextprotocol.io#stateless-protocol-stateful-applications)
...
### Server-to-client requests, restructured[#](https://blog.modelcontextprotocol.io#server-to-client-requests-restructured)
...
### Routable, cacheable, traceable[#](https://blog.modelcontextprotocol.io#routable-cacheable-traceable)
...
## Extensions Become First-Class[#](https://blog.modelcontextprotocol.io#extensions-become-first-class)
...
### MCP Apps: server-rendered user interfaces[#](https://blog.modelcontextprotocol.io#mcp-apps-server-rendered-user-interfaces)
...
### Tasks graduates to an extension[#](https://blog.modelcontextprotocol.io#tasks-graduates-to-an-extension)
...
## Authorization Hardening[#](https://blog.modelcontextprotocol.io#authorization-hardening)
...
## Roots, Sampling, and Logging Are Deprecated[#](https://blog.modelcontextprotocol.io#roots-sampling-and-logging-are-deprecated)

Three core features are deprecated under the new
[feature lifecycle policy](https://blog.modelcontextprotocol.io#how-the-protocol-evolves-from-here)
...
## Full JSON Schema 2020-12 for Tools[#](https://blog.modelcontextprotocol.io#full-json-schema-2020-12-for-tools)
...
## How the Protocol Evolves From Here[#](https://blog.modelcontextprotocol.io#how-the-protocol-evolves-from-here)
...
[Extensions framework](https://blog.modelcontextprotocol.io#extensions-become-first-class) means new capabilities
...
## Release Timeline and Validation[#](https://blog.modelcontextprotocol.io#release-timeline-and-validation)
...
## Looking Ahead[#](https://blog.modelcontextprotocol.io#looking-ahead)
