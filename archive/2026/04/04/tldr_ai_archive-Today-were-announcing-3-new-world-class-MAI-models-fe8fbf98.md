...
url: https://microsoft.ai/news/today-were-announcing-3-new-world-class-mai-models-available-in-foundry/?utm_source=tldrai
date: 2026-04-04
published_at: 2026-04-03T12:00:00+00:00
tag: 产品发布
item_id: fe8fbf98a1ecede7
---
#
...
Available now in [Microsoft Foundry](https://aka.ms/mai-foundry-tcblog) and [MAI Playground](https://msi-playground.microsoft.com/chat).
...
The model can generate 60 seconds of audio in just a single second, and highly efficient GPU usage delivers that quality and speed affordably. Hearing is believing, so experience it for yourself with [Copilot Audio Expressions](https://copilot.microsoft.com/labs/audio-expression) or Copilot Podcasts.

![The text "MAI-Transcribe-1" appears in bold, brown letters centered on a plain, light beige background.](https://microsoft.ai/wp-content/uploads/2026/04/poster.jpg)
...
![A woman stands holding an orange umbrella, photographed from a low angle. She wears a white blouse and blue jeans, with the background featuring a plain white wall.](https://microsoft.ai/wp-content/uploads/2026/04/image-2026-04-01T102042.461.png)

![A bottle labeled "Sofily" sits on a wooden table decorated with peach flowers and a vase of orange blooms, bathed in warm sunlight with a shadowy background.](https://microsoft.ai/wp-content/uploads/2026/04/image-2026-04-01T095242.896.png)
...
Starting today, every developer can build with MAI models, including **MAI-Transcribe-1**, through Microsoft Foundry. You can also try them in the [MAI Playground](https://msi-playground.microsoft.com/chat) (US only).

Interested in MAI models but don’t have Foundry access?

Fill out [this form](https://forms.microsoft.com/Pages/ResponsePage.aspx?id=v4j5cvGGr0GRqy180BHbR8gCrl3gVYtBmJ2JUAR22zRUNjI4VVlRQ044U0ZPVzVWUko3RFBSSE9aUC4u) and we’ll be in touch.
...
[Download Model Card for MAI-Transcribe-1](https://microsoft.ai/pdf/MAI-Transcribe-1-Model-Card.pdf)

[Download Model Card for MAI-Voice-1](https://microsoft.ai/pdf/MAI-Voice-1-Model-Card.pdf)

[Download Model Card for MAI-Image-2](https://microsoft.ai/pdf/MAI-Image-2-Model-Card.pdf)
