...
date: 2026-08-30
published_at: 2026-08-30T07:47:45.446870+00:00
tag: 工具开源
item_id: 8ccdd7d5cb1ca232
---
...
**The first open-source, agentic video production system.**
  ...
  [Paste A Video](https://github.com#start-from-a-video-you-already-love)  · 
  [Quick Start](https://github.com#quick-start)  · 
  [Try These Prompts](https://github.com#try-these-prompts)  · 
  [Pipelines](https://github.com#pipelines)  · 
  ...
  [Review Guide](https://github.com/calesthio/OpenMontage/blob/main/docs/PR_REVIEW_GUIDE.md)  · 
...
![Backlot live board — assets generating](https://github.com/calesthio/OpenMontage/raw/main/docs/images/backlot/board-live.png)
...
![Backlot storyboard — filmstrip with takes and renders](https://github.com/calesthio/OpenMontage/raw/main/docs/images/backlot/storyboard.png)


Creative gates hold until you answer. The board shows what's waiting and why; you reply in chat:

![Backlot script gate — awaiting approval](https://github.com/calesthio/OpenMontage/raw/main/docs/images/backlot/script-gate.png)


Every production on your machine, live-first, in the library:

![Backlot library](https://github.com/calesthio/OpenMontage/raw/main/docs/images/backlot/library.png)
...
3. **Check the actual capability envelope** Run:python -c "from tools.tool_registry import registry; import json; registry.discover(); print(json.dumps(registry.support_envelope(), indent=2))" python -c "from tools.tool_registry import registry; import json; registry.discover(); print(json.dumps(registry.provider_menu(), indent=2))"
