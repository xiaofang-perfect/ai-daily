...
date: 2026-08-23
published_at: 2026-08-23T02:57:34.293345+00:00
tag: 工具开源
item_id: 81806dfe06bd8b41
---
![Graphify](https://raw.githubusercontent.com/Graphify-Labs/graphify/v8/docs/logo.png)
...
```
**Works in** Claude Code, Cursor, Codex, Gemini CLI, GitHub Copilot, and 15+ more — [pick your platform](https://github.com#install).
...
```
See the [full command reference](https://github.com#full-command-reference) below.
...
```
The authoritative CI commands live in [`.github/workflows/`](https://github.com/Graphify-Labs/graphify/blob/v8/.github/workflows).
