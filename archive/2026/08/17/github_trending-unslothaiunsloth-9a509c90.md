...
date: 2026-08-17
published_at: 2026-08-17T02:55:31.302236+00:00
tag: 工具开源
item_id: 9a509c9033c1fa48
---
[Features](https://github.com#-features) •
  [Quickstart](https://github.com#-install) •
  [Notebooks](https://github.com#-free-notebooks) •
...
| **Platform** | **Link** | 
| **Windows** | [Download](https://github.com/unslothai/unsloth/releases/download/v0.1.800-beta/Unsloth-Desktop-0_1_800_beta-Windows.exe) | 
| **macOS** | [Download](https://github.com/unslothai/unsloth/releases/download/v0.1.800-beta/Unsloth-Desktop-0_1_800_beta-MacOS.dmg) | 
| **Linux / Ubuntu (deb)** | [Download](https://github.com/unslothai/unsloth/releases/download/v0.1.800-beta/Unsloth-Desktop-0_1_800_beta-Ubuntu.deb) | 
| **Linux (AppImage)** | [Download](https://github.com/unslothai/unsloth/releases/download/v0.1.800-beta/Unsloth-Desktop-0_1_800_beta-Linux.AppImage) | 
| **Linux (Arm64)** | [Download](https://github.com/unslothai/unsloth/releases/download/v0.1.800-beta/Unsloth-Desktop-0_1_800_beta-ARM64.app.tar.gz) | 

Download from [Unsloth](https://unsloth.ai/download) or [GitHub Releases](https://github.com/unslothai/unsloth/releases).

Or if you prefer to install manually:

`curl -fsSL https://unsloth.ai/install.sh | sh``irm https://unsloth.ai/install.ps1 | iex`
...
docker run -d -e JUPYTER_PASSWORD="mypassword" \
  ...
  unsloth/unsloth
```
To see developer, nightly and uninstallation etc. instructions, see [advanced installation](https://github.com#-advanced-installation).
...
```
If you trained a model with 🦥Unsloth, you can use this cool sticker!   ![](<https://raw.githubusercontent.com/unslothai/unsloth/main/images/made with unsloth.png>)
