...
date: 2026-08-31
published_at: 2026-08-31T08:01:38.373219+00:00
tag: 工具开源
item_id: bb272948ad46bb11
---
![OpenMAIC Banner](https://github.com/THU-MAIC/OpenMAIC/raw/main/assets/banner.png)
...
Get an immersive, multi-agent learning experience in just one click
  ...
  [English](https://github.com/THU-MAIC/OpenMAIC/blob/main/README.md) | [Simplified Chinese](https://github.com/THU-MAIC/OpenMAIC/blob/main/README-zh.md)
  

  [Live Demo](https://open.maic.chat/) · [Quick Start](https://github.com#-quick-start) · [Lemonade](https://github.com#lemonade-local-ai) · [FunASR](https://github.com#funasr-local-asr) · [Features](https://github.com#-features) · [Use Cases](https://github.com#-use-cases) · [OpenClaw](https://github.com#-openclaw-integration)
...
Take the full tour in [Features](https://github.com#-features), then set it up with [Agent workbench and runtime](https://github.com#optional-agent-workbench-and-runtime).
...
- **[OpenClaw integration](https://github.com#-openclaw-integration)** — Generate classrooms from Feishu, Slack, Telegram, and 20+ messaging apps via your AI assistant

Tip

###  OpenClaw — Use OpenMAIC from your chat app, zero setup
![](https://camo.githubusercontent.com/e1d0e31e6e27919792c5d37aa75b0002725eb2707ecec51ca7f6d364246244fe/68747470733a2f2f63646e2e6a7364656c6976722e6e65742f67682f686f6d6172722d6c6162732f64617368626f6172642d69636f6e732f706e672f6f70656e636c61772e706e67)
...
replace
[`lib/persistence/server-auth.ts`](https://github.com/THU-MAIC/OpenMAIC/blob/main/lib/persistence/server-auth.ts) with real
...
[asset HTTP contract](https://github.com/THU-MAIC/OpenMAIC/blob/main/packages/@openmaic/storage/docs/asset-http-contract.md).

The embedded endpoint implements the package's
[RuntimeStore HTTP contract](https://github.com/THU-MAIC/OpenMAIC/blob/main/packages/@openmaic/storage/docs/runtime-http-contract.md)
and
[DocumentStore HTTP contract](https://github.com/THU-MAIC/OpenMAIC/blob/main/packages/@openmaic/storage/docs/document-http-contract.md).
...
development tokens described in [Server-backed persistence](https://github.com#server-backed-persistence-postgresql).
...
![VoxCPM2 connection settings: backend selector, Base URL, model](https://github.com/THU-MAIC/OpenMAIC/raw/main/assets/voxcpm/voxcpm-connection.png)
...
![VoxCPM2 VoxCPM Voices section with Auto, Prompt and Clone modes](https://github.com/THU-MAIC/OpenMAIC/raw/main/assets/voxcpm/voxcpm-voice-manager.png)
...
| **🌐 3D Visualization** Three-dimensional visual representations that make abstract structures more intuitive. ![](https://github.com/THU-MAIC/OpenMAIC/raw/main/assets/interactive_mode/3D_interactive.gif) | **⚙️ Simulation** Process simulations and experimental environments for observing dynamic changes and outcomes. ![](https://github.com/THU-MAIC/OpenMAIC/raw/main/assets/interactive_mode/simulation_interactive.gif) | 
| **🎮 Game** Knowledge-based mini-games that reinforce understanding and memory through interactive challenges. ![](https://github.com/THU-MAIC/OpenMAIC/raw/main/assets/interactive_mode/game_interactive.gif) | **🧭 Mind Map** Structured knowledge organization to help learners build an overall conceptual framework. ![](https://github.com/THU-MAIC/OpenMAIC/raw/main/assets/interactive_mode/mindmap_interactive.gif) | 
| **💻 Online Programming** In-browser coding and instant execution for learning by writing, testing, and iterating. ![](https://github.com/THU-MAIC/OpenMAIC/raw/main/assets/interactive_mode/code_interactive.gif) |  | 
...
![](https://github.com/THU-MAIC/OpenMAIC/raw/main/assets/interactive_mode/teacher_action_interative.gif)


All generated interactive UI is fully responsive — desktop, tablet, or mobile.

| **Desktop** ![](https://github.com/THU-MAIC/OpenMAIC/raw/main/assets/interactive_mode/desktop_interactive.png) | **Mobile** ![](https://github.com/THU-MAIC/OpenMAIC/raw/main/assets/interactive_mode/phone_interactive.png) | 
| **iPad** ![](https://github.com/THU-MAIC/OpenMAIC/raw/main/assets/interactive_mode/ipad_interactive.png) |  | 
...
| **Available on ClawHub** — Install with one command: `clawhub install openmaic`Or copy manually: ``` mkdir -p ~/.openclaw/skills cp -R /path/to/OpenMAIC/skills/openmaic ~/.openclaw/skills/openmaic ```  | 
...
|   ![](https://github.com/THU-MAIC/OpenMAIC/raw/main/assets/python.gif) |   ![](https://github.com/THU-MAIC/OpenMAIC/raw/main/assets/avalon.gif) | 
|   ![](https://github.com/THU-MAIC/OpenMAIC/raw/main/assets/zhipu-minimax.gif) |   ![](https://github.com/THU-MAIC/OpenMAIC/raw/main/assets/deepseek.gif) | 
...
This project is licensed under the MIT License, so commercial use is permitted free of charge. For partnership or collaboration inquiries, please contact: [thu_maic@mail.tsinghua.edu.cn](mailto:thu_maic@mail.tsinghua.edu.cn)
...
```
This project is licensed under the [MIT License](https://github.com/THU-MAIC/OpenMAIC/blob/main/LICENSE).

The repository bundles workspace packages that are **not** covered by the root MIT license and keep their own terms:

- `packages/mathml2omml` —[LGPL-3.0-or-later](https://github.com/THU-MAIC/OpenMAIC/blob/main/packages/mathml2omml/LICENSE)
- `packages/pptxgenjs` —[MIT](https://github.com/THU-MAIC/OpenMAIC/blob/main/packages/pptxgenjs/package.json) (third-party)
