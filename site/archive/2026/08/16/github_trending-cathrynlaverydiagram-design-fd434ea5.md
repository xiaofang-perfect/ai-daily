...
date: 2026-08-16
published_at: 2026-08-16T02:55:15.959906+00:00
tag: 工具开源
item_id: fd434ea52d3f3da9
---
**Editorial diagrams your designer won't hate.**

![Content site architecture](https://github.com/cathrynlavery/diagram-design/raw/main/docs/screenshots/architecture.png)


![The self-improving loop](https://github.com/cathrynlavery/diagram-design/raw/main/docs/screenshots/loop.png)
...
| ![Architecture](https://github.com/cathrynlavery/diagram-design/raw/main/docs/screenshots/architecture.png) **Architecture**<sub>Components + connections</sub> | ![Flowchart](https://github.com/cathrynlavery/diagram-design/raw/main/docs/screenshots/flowchart.png) **Flowchart**<sub>Decision logic</sub> | ![Sequence](https://github.com/cathrynlavery/diagram-design/raw/main/docs/screenshots/sequence.png) **Sequence**<sub>Messages over time</sub> | 
| ![State machine](https://github.com/cathrynlavery/diagram-design/raw/main/docs/screenshots/state.png) **State machine**<sub>States + transitions</sub> | ![ER](https://github.com/cathrynlavery/diagram-design/raw/main/docs/screenshots/er.png) **ER / data model**<sub>Entities + fields</sub> | ![Timeline](https://github.com/cathrynlavery/diagram-design/raw/main/docs/screenshots/timeline.png) **Timeline**<sub>Events on an axis</sub> | 
| ![Swimlane](https://github.com/cathrynlavery/diagram-design/raw/main/docs/screenshots/swimlane.png) **Swimlane**<sub>Cross-functional flow</sub> | ![Quadrant](https://github.com/cathrynlavery/diagram-design/raw/main/docs/screenshots/quadrant.png) **Quadrant**<sub>Two-axis positioning</sub> | ![Nested](https://github.com/cathrynlavery/diagram-design/raw/main/docs/screenshots/nested.png) **Nested**<sub>Hierarchy by containment</sub> | 
| ![Tree](https://github.com/cathrynlavery/diagram-design/raw/main/docs/screenshots/tree.png) **Tree**<sub>Parent → children</sub> | ![Org chart](https://github.com/cathrynlavery/diagram-design/raw/main/docs/screenshots/org-chart.png) **Org chart**<sub>Ownership + routing</sub> | ![Venn](https://github.com/cathrynlavery/diagram-design/raw/main/docs/screenshots/venn.png) **Venn**<sub>Set overlap</sub> | 
| ![Layers](https://github.com/cathrynlavery/diagram-design/raw/main/docs/screenshots/layers.png) **Layer stack**<sub>Stacked abstractions</sub> | ![Pyramid](https://github.com/cathrynlavery/diagram-design/raw/main/docs/screenshots/pyramid.png) **Pyramid / funnel**<sub>Ranked hierarchy or drop-off</sub> | ![Consultant 2×2](https://github.com/cathrynlavery/diagram-design/raw/main/docs/screenshots/quadrant-consultant.png) **Consultant 2×2**<sub>Scenario matrix · named cells</sub> | 
| ![Radar](https://github.com/cathrynlavery/diagram-design/raw/main/docs/screenshots/radar.png) **Radar / Spider**<sub>Multi-axis comparison</sub> | ![Loop](https://github.com/cathrynlavery/diagram-design/raw/main/docs/screenshots/loop.png) **Loop**<sub>Flywheel · stations around a hub</sub> | ![IT current-state](https://github.com/cathrynlavery/diagram-design/raw/main/docs/screenshots/it-state.png) **IT current-state**<sub>Legacy landscape · modernization</sub> | 
| ![High-Level](https://github.com/cathrynlavery/diagram-design/raw/main/docs/screenshots/high-level.png) **High-Level**<sub>End-to-end stack on a cluster</sub> | ![Bar chart](https://github.com/cathrynlavery/diagram-design/raw/main/docs/screenshots/bar.png) **Bar chart**<sub>Categorical comparison</sub> | ![Line chart](https://github.com/cathrynlavery/diagram-design/raw/main/docs/screenshots/line.png) **Line chart**<sub>Trends over time</sub> | 
| ![Gantt](https://github.com/cathrynlavery/diagram-design/raw/main/docs/screenshots/gantt.png) **Gantt**<sub>Tasks and phases on a timeline</sub> | ![Scatter plot](https://github.com/cathrynlavery/diagram-design/raw/main/docs/screenshots/scatter.png) **Scatter plot**<sub>Distribution and correlation</sub> | ![Process](https://github.com/cathrynlavery/diagram-design/raw/main/docs/screenshots/process.png) **Process**<sub>Multi-actor sequential workflow</sub> | 
| ![Medallion](https://github.com/cathrynlavery/diagram-design/raw/main/docs/screenshots/medallion.png) **Medallion**<sub>Multi-tier data storage</sub> | ![Data flow](https://github.com/cathrynlavery/diagram-design/raw/main/docs/screenshots/data-flow.png) **Data flow**<sub>Role-scoped pipeline steps</sub> | ![DP integration](https://github.com/cathrynlavery/diagram-design/raw/main/docs/screenshots/dp-integration.png) **DP integration**<sub>Sources → core → consumers</sub> | 
| ![DP security matrix](https://github.com/cathrynlavery/diagram-design/raw/main/docs/screenshots/dp-security-matrix.png) **DP security matrix**<sub>Per-role access permissions</sub> |  |  | 

**Browse the live gallery:** [cathrynlavery.github.io/diagram-design](https://cathrynlavery.github.io/diagram-design/) — or open [`skills/diagram-design/assets/index.html`](https://github.com/cathrynlavery/diagram-design/blob/main/skills/diagram-design/assets/index.html) locally to flip through all 27 diagrams with light / dark / full-editorial tabs.
...
Prefer to set tokens by hand? Open [`skills/diagram-design/references/style-guide.md`](https://github.com/cathrynlavery/diagram-design/blob/main/skills/diagram-design/references/style-guide.md) and edit the table. Everything downstream reads from there — all 27 diagrams, the annotation primitive, and the gallery all inherit semantic role names (`accent`, not `#eb6c36`).
...
See [`skills/diagram-design/references/onboarding.md`](https://github.com/cathrynlavery/diagram-design/blob/main/skills/diagram-design/references/onboarding.md) for the full spec.
...
The profile library is shared across Claude Code, Codex, and Pi. Use `/diagram-design:profile` in Claude Code, `/profile` in Pi, or ask in natural language in any host. See [`profiles.md`](https://github.com/cathrynlavery/diagram-design/blob/main/skills/diagram-design/references/profiles.md) for the storage, marker, and recovery contract.
...
Motion is optional and does not create another visual type. [`animation.md`](https://github.com/cathrynlavery/diagram-design/blob/main/skills/diagram-design/references/animation.md) defines `none`, `reveal`, `step`, and `loop` modes with a complete static first frame, deterministic timing, and controls when interaction is available. Reduced-motion output shows the complete static frame and hides/disables playback controls. Motion HTML uses the exact reviewed controller from `template-motion.html`; arbitrary or modified inline scripts, remote assets, CSS imports, and executable HTML attributes are rejected. The default is `none`: ordinary output remains static and script-free. [`example-policy-trace-animated.html`](https://github.com/cathrynlavery/diagram-design/blob/main/skills/diagram-design/assets/example-policy-trace-animated.html) is the self-contained interactive example.
...
![Redrawn from a .drawio file](https://github.com/cathrynlavery/diagram-design/raw/main/docs/screenshots/import-drawio.png)
...
Both formats are diagram-only — editorial cards and headers from `-full` variants aren't included. For a screenshot of the full editorial layout, use your browser's print-to-PDF or full-page screenshot. See [`skills/diagram-design/references/export.md`](https://github.com/cathrynlavery/diagram-design/blob/main/skills/diagram-design/references/export.md) for the full procedure.
...
One accent color, 1–2 focal elements per diagram. Three font families: Instrument Serif (title + italic callouts), Geist sans (node names), Geist Mono (technical sublabels). 1px hairline borders, no shadows, max border-radius 10px. Every coord, width, and gap divisible by 4 — non-negotiable, it's what keeps the diagrams from feeling AI-generated. Mono is for technical content (ports, URLs, field types), not a blanket "dev" aesthetic. Coral-tinted focal nodes draw the eye to the 1–2 things that matter. Full spec in [`SKILL.md`](https://github.com/cathrynlavery/diagram-design/blob/main/skills/diagram-design/SKILL.md#5-design-system).

- **Annotation callout** — italic Instrument Serif + dashed Bézier leader, for editorial asides that sit in the margins. See[`skills/diagram-design/references/primitive-annotation.md`](https://github.com/cathrynlavery/diagram-design/blob/main/skills/diagram-design/references/primitive-annotation.md) .
- **Sketchy filter** — SVG turbulence + displacement map for a hand-drawn variant. Good for essays, not for technical docs. See[`skills/diagram-design/references/primitive-sketchy.md`](https://github.com/cathrynlavery/diagram-design/blob/main/skills/diagram-design/references/primitive-sketchy.md) .
- **Icon set** — 55 monochrome IT/cloud icons (laptop, phone, user, server, database, Docker, Kubernetes, AWS, Azure, GitHub, Postgres…) for richer architecture and sequence diagrams. Stroked icons from[Tabler Icons](https://tabler.io/icons) (MIT); brand silhouettes from[Simple Icons](https://simpleicons.org) (CC0). Each icon uses`currentColor` so it inherits the editorial skin or your onboarded brand. See[`skills/diagram-design/references/primitive-icons.md`](https://github.com/cathrynlavery/diagram-design/blob/main/skills/diagram-design/references/primitive-icons.md) ; browse the[gallery](https://github.com/cathrynlavery/diagram-design/blob/main/skills/diagram-design/assets/icons.html) . Regenerate with`python scripts/build-icons.py` .
...
Contributions are welcome — new diagram types, import grammar support, examples, docs, and tooling. See [CONTRIBUTING.md](https://github.com/cathrynlavery/diagram-design/blob/main/CONTRIBUTING.md) for the validation gates and workflows, and [CODE_OF_CONDUCT.md](https://github.com/cathrynlavery/diagram-design/blob/main/CODE_OF_CONDUCT.md) for community standards.
