...
date: 2026-08-19
published_at: 2026-08-19T02:55:17.059711+00:00
tag: 工具开源
item_id: 011435765ab4a144
---
![OpenViking](https://github.com/volcengine/OpenViking/raw/main/docs/images/ov-logo.png) 

[Website](https://www.openviking.ai) · [Live Demo](https://openviking.ai/studio) · [GitHub](https://github.com/volcengine/OpenViking) · [Issues](https://github.com/volcengine/OpenViking/issues) · [Docs](https://docs.openviking.ai/)
...
📱 [Lark Group](https://docs.openviking.ai/en/about/01-about-us#lark-group) · [WeChat](https://docs.openviking.ai/en/about/01-about-us#wechat-group) · [Discord](https://discord.com/invite/eHvx8E9XF3) · [X](https://x.com/openvikingai)
...
![OpenViking Studio playground](https://github.com/volcengine/OpenViking/raw/main/docs/images/studio-playground.png)
...
└── docs/
    ...
    └── api/
        ...
        └── endpoints.md
```
OpenViking 0.3.22 has been evaluated on long-conversation user memory (LoCoMo) and multi-turn agent tasks (tau2-bench). Full results and setup details, including knowledge-base QA, are in the [benchmark report](https://blog.openviking.ai/post/openviking-benchmark-results/); reproduction scripts live in [./benchmark](https://github.com/volcengine/OpenViking/blob/main/benchmark).
...
**The open-source edition is not crippled.** OpenViking in this repo is fully open source under AGPLv3: no feature gates, no account required, no activation key. Follow [Deploy in production](https://github.com#deploy-in-production) above and run it in production yourself — and that will stay true.

The two editions below answer "who operates it and where it runs", not "can I use it".

| ![Managed SaaS](https://github.com/volcengine/OpenViking/raw/main/docs/images/commercial-saas.png)  Officially hosted on **Volcano Engine** . Nothing to set up, nothing to operate. **Personal** — for individual developers. Free trial for up to 50 files, and scales far beyond local hardware with VikingDB. **Enterprise** — multi-user context management, team collaboration and permissions, enterprise SLA and support. Existing open-source users can move over with the migration tool. [**→ Volcano Engine product page**](https://www.volcengine.com/product/openviking-service) ·[Documentation](https://docs.volcengine.com/docs/84313/2374478) <sub>Global hosting for regions outside China is coming to [BytePlus](https://www.byteplus.com).</sub> | ![Self-Managed](https://github.com/volcengine/OpenViking/raw/main/docs/images/commercial-self-hosted.png)  Runs **inside your own environment** . Data never leaves it. **Online** — deployed into your own cloud account / VPC, BYOC supported, with outbound access for updates and licensing. **Offline** — fully air-gapped environments with no internet access, for regulated industries. Adds distributed deployment and official support on top of the open-source edition, activated by license key. **→ Talk to us about self-managed deployment** | 

Just want to run the open-source edition? Go ahead — you don't need to contact anyone. Head to [Quick start](https://github.com#quick-start).
...
- **Contribute** : bug fixes and new features are both welcome — see[CONTRIBUTING.md](https://github.com/volcengine/OpenViking/blob/main/CONTRIBUTING.md)
