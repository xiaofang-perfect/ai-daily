...
url: https://huggingface.co/blog/ibm-research/cuga-apps?utm_source=tldrai
date: 2026-06-25
published_at: 2026-06-24T12:00:00+00:00
tag: 工具开源
item_id: abe461dce9d9f01b
---
🚀    31   
...
`pip install cuga`, then OpenAI, watsonx, Ollama, and more) — each something you'd otherwise build yourself. The first word of the name does the work: Here's the IBM Cloud advisor — an agent that recommends real IBM Cloud services for an architecture. The whole thing fits in one file: a `main.py` with the agent factory, the tools, and the prompt, plus a small UI.
...
More from this author
 ...
 May 27, 2026 Sovereign, Open, Self-Learning Agents: [https://github.com/cuga-project/cuga-agent](https://github.com/cuga-project/cuga-agent).
