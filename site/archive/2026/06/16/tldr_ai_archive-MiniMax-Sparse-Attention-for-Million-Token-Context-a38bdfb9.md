...
url: https://github.com/MiniMax-AI/MSA?utm_source=tldrai
date: 2026-06-16
published_at: 2026-06-15T12:00:00+00:00
tag: 工具开源
item_id: a38bdfb964203d61
---
...
![MSA architecture](https://github.com/MiniMax-AI/MSA/raw/main/docs/architecture.png)
...
License: MIT.Self-authored files carry`SPDX-License-Identifier: MIT`. See[LICENSE](https://github.com/MiniMax-AI/MSA/blob/main/LICENSE)and[NOTICE](https://github.com/MiniMax-AI/MSA/blob/main/NOTICE). Bundled / derived third-party code retains its own license — see[Third-party licenses](https://github.com#third-party-licenses).
...
`python benchmarks/bench_sparse_attention_ops.py --help     # full flag list`Common invocations (output is TSV):
...
|---|---|---|
| `quack-kernels` | [https://github.com/Dao-AILab/quack](https://github.com/Dao-AILab/quack) | Apache-2.0 | 
...
| `torch` | [https://github.com/pytorch/pytorch](https://github.com/pytorch/pytorch) | BSD-3-Clause | 
| `jinja2` | [https://github.com/pallets/jinja](https://github.com/pallets/jinja) | BSD-3-Clause | 
| `ninja` | [https://github.com/ninja-build/ninja](https://github.com/ninja-build/ninja) | Apache-2.0 | 
| `pybind11` | [https://github.com/pybind/pybind11](https://github.com/pybind/pybind11) | BSD-3-Clause | 
...
[ docs/MiniMaxSparseAttention.pdf](https://github.com/MiniMax-AI/MSA/blob/main/docs/MiniMaxSparseAttention.pdf).
