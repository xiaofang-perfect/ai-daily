...
date: 2026-06-16
published_at: 2026-06-16T07:23:13.014501+00:00
tag: 工具开源
...
`docker run --rm -v "$PWD:/scan" skillspector scan ./my-skill/ --no-llm`**Scan with LLM analysis** by passing credentials with a local `.env` file:
