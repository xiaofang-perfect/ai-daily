...
url: https://www.anthropic.com/engineering/how-we-contain-claude?utm_source=tldrai
date: 2026-05-28
published_at: 2026-05-27T12:00:00+00:00
tag: 论文研究
item_id: 34cbc3310269fa2f
---
...
This also makes [claude.ai](http://claude.ai/redirect/website.v1.80bcab51-f936-4271-a504-21c5237f0faa) subject to a more traditional threat model. We're not protecting user machines from agents; we're protecting our own infrastructure and each tenant from one another. Our pre-launch work for [claude.ai](http://claude.ai/redirect/website.v1.80bcab51-f936-4271-a504-21c5237f0faa) was dominated by traditional security work like network configuration, internal service auth, and orchestration.
...
Environment | Ephemeral container (
|
|---|
