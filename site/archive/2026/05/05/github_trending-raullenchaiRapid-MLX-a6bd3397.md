...
date: 2026-05-05
published_at: 2026-05-05T04:58:53.254606+00:00
tag: 工具开源
item_id: a6bd339728a0b471
---
...
![Rapid-MLX demo — install, serve Gemma 4, chat, tool calling](https://raw.githubusercontent.com/raullenchai/Rapid-MLX/main/docs/assets/demo.gif)
...
Vision/multimodal models(Gemma 4, Qwen-VL, etc.) need extras:`pip install 'rapid-mlx[vision]'`

. Text-only install is ~460 MB; vision adds ~322 MB. See[Optional Extras]for the full list.


"No matching distribution" error?Your Python is too old. Run`python3 --version`

— if it says 3.9, install a newer Python:`brew install python@3.12`

then`python3.12 -m pip install rapid-mlx`
...
then`rapid-mlx serve gemma-4-26b`
...
Tip:Run`rapid-mlx models`

to see all available model aliases. For a smaller/faster model, try`rapid-mlx serve qwen3.5-9b`
...
[test](https://github.com/raullenchai/Rapid-MLX/blob/main/tests/integrations/test_hermes.py))[PydanticAI](https://ai.pydantic.dev)[test](https://github.com/raullenchai/Rapid-MLX/blob/main/tests/integrations/test_pydantic_ai_full.py))[LangChain](https://langchain.com)`ChatOpenAI`

, tools, streaming ([test](https://github.com/raullenchai/Rapid-MLX/blob/main/tests/integrations/test_langchain.py))[smolagents](https://github.com/huggingface/smolagents)[test](https://github.com/raullenchai/Rapid-MLX/blob/main/tests/integrations/test_smolagents_full.py))[OpenClaude](https://github.com/Gitlawb/openclaude)(Anthropic SDK)`CLAUDE_CODE_USE_OPENAI=1`

([test](https://github.com/raullenchai/Rapid-MLX/blob/main/tests/integrations/test_anthropic_sdk.py))[Aider](https://aider.chat)[test](https://github.com/raullenchai/Rapid-MLX/blob/main/tests/integrations/test_aider.sh))[Goose](https://github.com/block/goose)`OLLAMA_HOST`

[Claw Code](https://github.com/ultraworkers/claw-code)| Client | Status | Setup |
|---|---|---|
|

[Continue.dev](https://continue.dev)[LibreChat](https://librechat.ai)[test](https://github.com/raullenchai/Rapid-MLX/blob/main/tests/integrations/test_librechat_docker.py))[Open WebUI](https://github.com/open-webui/open-webui)[test](https://github.com/raullenchai/Rapid-MLX/blob/main/tests/integrations/test_openwebui.py))`http://localhost:8000/v1`
...
|---|---|---|---|
Tool Calling |
50% | Can the model+harness execute function calls correctly? | `rapid-mlx agents --test` |
HumanEval |
30% | Can the model generate correct code? |
|

**MMLU**[tinyMMLU](https://huggingface.co/datasets/tinyBenchmarks/tinyMMLU)(10 tasks)**MHI = 0.50 × ToolCalling + 0.30 × HumanEval + 0.20 × MMLU** (scale 0-100)

| Model | Best MHI | Best Harness | Tool Calling |
|---|---|---|---|
Qwopus 27B |
92 |
All (Hermes, PydanticAI, LangChain, smolagents) | 100% |
Qwen3.5 27B |
82 |
Hermes / PydanticAI / LangChain | 100% |
Llama 3.3 70B |
83 |
smolagents (text-based) | 100% |
Nemotron Nano 30B |
59 |
PydanticAI / LangChain | 91-93% |
Gemma 4 26B |
62 |
Hermes / smolagents | 100% |
...
Qwopus 27B + Hermes |
100% | 80% | 90% | 92 |
Qwopus 27B + PydanticAI |
100% | 80% | 90% | 92 |
Qwen3.5 27B + Hermes |
100% | 40% | 100% | 82 |
Llama 3.3 70B + smolagents |
100% | 50% | 90% | 83 |
DeepSeek-R1 32B + smolagents |
100% | 30% | 100% | 79 |
Gemma 4 26B + Hermes |
100% | 0% | 60% | 62 |
Nemotron Nano 30B + PydanticAI |
93% | 0% | 60% | 59 |
...
|---|---|---|---|---|
16 GB MacBook Air/Pro |
|

**24 GB**MacBook Pro[Qwen3.5-9B 4bit](https://huggingface.co/mlx-community/Qwen3.5-9B-4bit)**32 GB**Mac Mini / Studio[Qwen3.5-27B 4bit](https://huggingface.co/mlx-community/Qwen3.5-27B-4bit)**32 GB**Mac Mini / Studio[Nemotron-Nano 30B 4bit](https://huggingface.co/lmstudio-community/NVIDIA-Nemotron-3-Nano-30B-A3B-MLX-4bit)**32 GB**Mac Mini / Studio[Qwen3.6-35B-A3B 4bit](https://huggingface.co/mlx-community/Qwen3.6-35B-A3B-4bit)**36 GB**MacBook Pro M3/M4 Pro[Qwen3.5-27B 4bit](https://huggingface.co/mlx-community/Qwen3.5-27B-4bit)**48 GB**Mac Mini / Studio[Qwen3.5-35B-A3B 8bit](https://huggingface.co/mlx-community/Qwen3.5-35B-A3B-8bit)**Sweet spot**— smart + fast**64 GB**Mac Mini / Studio[Qwen3.5-35B-A3B 8bit](https://huggingface.co/mlx-community/Qwen3.5-35B-A3B-8bit)**96 GB**Mac Studio / Pro[Qwen3.5-122B mxfp4](https://huggingface.co/nightmedia/Qwen3.5-122B-A10B-Text-mxfp4-mlx)**128 GB**Mac Studio / Pro[DeepSeek V4 Flash 2-bit DQ](https://huggingface.co/mlx-community/DeepSeek-V4-Flash-2bit-DQ)**192 GB**Mac Studio / Pro[Qwen3.5-122B 8bit](https://huggingface.co/mlx-community/Qwen3.5-122B-A10B-8bit)**256 GB**Mac Studio Ultra[DeepSeek V4 Flash 8-bit](https://huggingface.co/mlx-community/DeepSeek-V4-Flash-8bit)
...
Phi-4 Mini 14B |
180 tok/s |
77 (mlx-lm) / 56 (Ollama) | 2.3x / 3.2x |
Qwen3.5-4B |
160 tok/s |
155 (mlx-lm serve) | 1.0x |
Nemotron-Nano 30B |
141 tok/s · 100% tools |
— | — |
🆕 DeepSeek V4 Flash 158B-A13B (2-bit DQ) |
56 tok/s |
— (only MLX engine, day-0) | — |
🆕 DeepSeek V4 Flash 158B-A13B (8-bit) |
31 tok/s |
— (only MLX engine, day-0) | — |
GPT-OSS 20B |
127 tok/s · 100% tools |
79 (mlx-lm serve) | 1.6x |
Qwen3.5-9B |
108 tok/s |
41 (Ollama) | 2.6x |
Qwen3.6-35B-A3B |
...
Qwen3-Coder 80B |
74 tok/s · 100% tools |
69 (mlx-lm serve) | 1.1x |
Qwen3.5-122B |
44 tok/s · 100% tools |
43 (mlx-lm serve) | ~1.0x |
Gemma 4 31B |
31 tok/s |
— | — |
...
| Llama 3.2 3B | 0.10s |
— | — |
| Hermes-3-Llama 8B | 0.10s |
0.18s | 1.8x |
| Phi-4 Mini 14B | 0.13s |
0.15s | 1.2x |
| Devstral-Small-2 24B | 0.13s |
0.38s | 2.9x |
| Mistral Small 24B | 0.13s |
0.38s | 2.9x |
| GLM-4.7-Flash 9B | 0.13s |
0.23s | 1.8x |
| GLM-4.5-Air | 0.14s |
0.47s | 3.4x |
| Qwen3-Coder-Next 80B | 0.16s |
0.27s | 1.7x |
| GPT-OSS 20B | 0.16s |
0.27s | 1.7x |
| Qwen3.5-9B | 0.22s |
...
| Gemma 4 E4B | 0.25s |
— (day-0) | — |
| Gemma 4 26B-A4B | 0.25s |
— (day-0) | — |
| Gemma 4 31B | 0.34s |
0.57s (mlx-vlm bf16) | 1.7x |
...
|---|---|---|---|
| Qwen3-Coder-Next 6bit (48L) | 0.66s | 0.16s |
4.3x |
| Qwen3.5-35B-A3B 8bit (40L) | 0.49s | 0.19s |
2.6x |
| Qwen3.5-27B 4bit (40L) | 0.58s | 0.27s |
2.1x |
| Qwen3.5-9B 4bit (40L) | 0.27s | 0.22s |
1.2x |
| Qwen3.5-4B 4bit (32L) | 0.24s | 0.16s |
1.5x |
...
|---|---|---|---|---|---|
Tool calling |
100% (Qwen/GLM/GPT-OSS/Kimi) | N/A | 100% (Qwen) | 80% (Phi-4) | N/A |
Tool call recovery |
100% | N/A | 100% | 100% | N/A |
...
|---|---|---|
KV prompt cache |
Trim KV cache to common prefix, skip re-prefill | All transformer models |
DeltaNet state snapshots |
Deep-copy RNN state at prefix boundary, restore in ~0.1ms | Qwen3.5 (4B, 9B, 27B, 35B, 122B), Qwen3-Coder-Next |
Hybrid cache sync |
Keep trimmable KV + non-trimmable RNN layers in sync | Qwen3.5 (Gated DeltaNet + attention) |
Tool logits bias |
Jump-forward decoding — bias logits toward structured tokens | All models with `--enable-tool-logits-bias` |
Auto tool recovery |
Detect broken text-format tool calls, convert to structured | All 18 parser formats (incl. Gemma 4) |
TurboQuant V-cache |
Rotate + Lloyd-Max compress V cache (86% savings on dense models) | All models with `--kv-cache-turboquant` |
KV cache quantization |
Quantize prefix cache entries to reduce memory | All models with `--kv-cache-quantization` |
Prefill chunking |
Configurable step size for large-prompt throughput | All models |
Cloud routing |
Offload high-token requests to cloud LLM when local is slow | All models with `--cloud-model` |
...
), and [2100+ tests](https://github.com/raullenchai/Rapid-MLX/blob/main/tests).
...
**Out of memory / very slow (<5 tok/s)** — Model too big. Check [What fits my Mac?](https://github.com#what-fits-my-mac) Try a smaller quantization (4bit) or smaller model.
...
`vision` |
`pip install 'rapid-mlx[vision]'` |
~322 MB | Gemma 4, Qwen-VL, video understanding (mlx-vlm + opencv + torch) |
`audio` |
`pip install 'rapid-mlx[audio]'` |
~600 MB | TTS / STT (mlx-audio + spacy + scipy) |
`embeddings` |
...
[EAGLE-3](https://arxiv.org/abs/2503.01840)— feature-level draft on Metal[ReDrafter](https://arxiv.org/abs/2403.09919)— Apple's RNN draft headWe welcome contributions of all sizes! See [CONTRIBUTING.md](https://github.com/raullenchai/Rapid-MLX/blob/main/CONTRIBUTING.md) for setup and guidelines.

**Easy first contributions** (no model download needed):

[Add a model alias](https://github.com/raullenchai/Rapid-MLX/issues?q=is%3Aissue+is%3Aopen+label%3A%22good+first+issue%22)— map a short name to a HuggingFace model ID[Request model support](https://github.com/raullenchai/Rapid-MLX/issues/new?template=model_support.yml)— tell us which model you want
...
Apache 2.0 — see [LICENSE](https://github.com/raullenchai/Rapid-MLX/blob/main/LICENSE).
