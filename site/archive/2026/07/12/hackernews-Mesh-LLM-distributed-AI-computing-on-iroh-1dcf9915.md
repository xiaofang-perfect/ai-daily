...
date: 2026-07-12
published_at: 2026-07-11T22:38:57+00:00
tag: 工具开源
item_id: 1dcf9915ac59d6e7
---
# Mesh LLM: distributed AI computing on iroh

by Rae McKelvey![Distributed Model Inference: a mesh of laptop, GPU rig, mini PC, server, workstation, and cloud nodes connected directly to each other](https://www.iroh.computer/blog/mesh-llm/header.png) 
...
[The problem: AI is expensive, and it is somebody else's](https://www.iroh.computer#the-problem-ai-is-expensive-and-it-is-somebody-elses)
...
[Mesh LLM: run the models yourself](https://www.iroh.computer#mesh-llm-run-the-models-yourself)
...
[How it works](https://www.iroh.computer#how-it-works)
...
[How it uses iroh](https://www.iroh.computer#how-it-uses-iroh)
...
[Getting started](https://www.iroh.computer#getting-started)
